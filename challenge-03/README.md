...
*/
pessoa.nomeCompleto(); //'Olá ! Meu nome é Lucas Santana!'
...
pessoa.mostrarPeso(); //'Eu peso 64 Kg.'
...
pessoa.apresentacao = function() {
    ...
    return 'Olá, eu sou ' + sexo + ' ' + nomeCompleto + ', tenho ' + pessoa.idade + ' ' + idade + ', ' + pessoa.altura + ', meu peso é ' + pessoa.peso + ' e, só hoje, eu já caminhei ' + pessoa.caminhouQuantosMetros + ' ' + metro + '!';
